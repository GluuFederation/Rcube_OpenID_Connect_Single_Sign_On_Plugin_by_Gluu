$(document).ready(function(){
    var text = '<li class="listitem" id="settingsgluusso">' +
        '<a href="./?_task=settings&amp;_action=plugin.gluu_sso" >OpenID Connect Single Sign-On (SSO) Plugin by Gluu 2.4.3</a></li>';
    $('#settings-sections #settings-tabs .listing').append(text);
    var text = '<span class="tablink gluusso " id="settingstabgluusso">' +
        '<a href="./?_task=settings&amp;_action=plugin.gluu_sso">OpenID Connect Single Sign-On (SSO) Plugin by Gluu 2.4.3</a></span>';
    $('#tabsbar').append(text);
